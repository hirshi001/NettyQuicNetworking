...
/**
 * A message that contains a float.
 *
...
public class FloatMessage extends Message {
    ...
    /**
     * Creates a new FloatMessage with the value set to 0.
     */
    public FloatMessage() {
        super();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof FloatMessage)) return false;
        FloatMessage message = (FloatMessage) obj;
