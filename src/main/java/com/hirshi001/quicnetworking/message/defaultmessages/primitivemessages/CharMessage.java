...
/**
 * A message that contains a char.
 *
...
public class CharMessage extends Message {
    ...
    /**
     * Creates a new CharMessage with the value set to 0.
     */
    public CharMessage() {
        super();
    }
    ...
    /**
     * Creates a new CharMessage with the value set to the argument.
     *
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CharMessage)) return false;
        CharMessage message = (CharMessage) obj;
